namespace UMLToMVCConverter.Generators
{
    ...
    public class TypesGenerator : ITypesGenerator
    {
        ...
        public TypesGenerator(IXmiWrapper xmiWrapper,
            ...
            IPropertyDeserializer propertyDeserializer,
        ...
        private void GenerateProperties(XElement xType, TypeModel type)
        {
            ...
            {
                var property = this.propertyDeserializer.Create(type, xAttribute);
                if (property != null)
                {
            ...
            if (type.IsEnum)
            {
                ...
                var property = this.propertyDeserializer.CreateBasicProperty("Name", typeof(string));
                type.Properties.Add(property);
            }
        }
