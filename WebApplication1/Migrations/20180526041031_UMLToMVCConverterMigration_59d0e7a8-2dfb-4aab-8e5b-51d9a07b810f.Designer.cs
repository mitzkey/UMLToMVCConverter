            ...
            modelBuilder.Entity("WebApplication1.Models.Car", b =>
                {
                    ...
                    b.HasIndex("SuperRadioID")
                        .IsUnique()
                        .HasFilter("[SuperRadioID] IS NOT NULL");
            ...
            modelBuilder.Entity("WebApplication1.Models.Car", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.CarRadio", "SuperRadio")
                        .WithOne("RadiosCar")
                        .HasForeignKey("WebApplication1.Models.Car", "SuperRadioID");
                });
